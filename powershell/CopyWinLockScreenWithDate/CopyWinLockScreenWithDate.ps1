...
# 配置锁屏图片位置
# $WindowsLockScreenPath = "C:\Users\$env:UserName\AppData\Local\Packages\Microsoft.Windows.ContentDeliveryManager_*\LocalState\Assets"
...
# 列出锁屏位置所有图片
$listfile = Get-ChildItem -Path $WindowsLockScreenPath
if (-not $listfile) {
